# PRU Servo — Raw Iteration Journal (1,562 lines)

> **The unedited chronological record** of every board iteration, command, readback,
> and wrong turn from 2026-08-26 → 2026-08-28. Kept verbatim as a reference trail.
>
> **Companion docs (read these first for understanding):**
> - `PRU_SERVO_DEBUG_LOG.md` — the *teaching* document: explains R30, pinmux,
>   remoteproc, OCP, libgpiod, and the bit-mapping as concepts.
